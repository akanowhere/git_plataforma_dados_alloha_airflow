SELECT 
    ...
    DATEDIFF(day, c1.data_cancelamento, c2.data_primeira_ativacao) AS tempo_cancelamento_ativacao,
...
WHERE 
    ...
    AND c2.data_primeira_ativacao >= '2023-01-01'
    AND DATEDIFF(day, c1.data_cancelamento, c2.data_primeira_ativacao) BETWEEN 0 AND 40
