...
pipeline_options["APP_AUTH_LOJA"] = Variable.get("APP_AUTH_LOJA")
...
@dag(
    dag_id="Ingestion_loja_app_pipeline",
    default_args={
    ...
    catchup=False,
    tags=["loja", "daily", "job_databricks", "landing", "bronze"],
)
def loja_dag() -> None:
    ...
    to_gold_tasks = AirflowUtil().create_dbt_task_group(
        ...
        schema="loja_app",
        select_paths=["path:models/gold/loja_app"],
        exclude=[""],
    )
