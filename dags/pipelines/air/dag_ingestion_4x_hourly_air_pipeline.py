...
@dag(
    dag_id="Ingestion_4x_hourly_air_pipeline",
    default_args={
    ...
    catchup=False,
    tags=["air", "4x_hourly", "job_databricks", "landing", "bronze"],
)
def air_dag() -> None:
    ...
    to_landing = air_to_landing()
    to_bronze = air_to_bronze()
    end_task = end_task()
