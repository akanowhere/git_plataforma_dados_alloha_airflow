...
pipeline_options = eval(Variable.get("FINTALK_PIPELINE_OPTIONS"))
pipeline_options["frequency"] = "hourly"
...
# Obtendo os parâmetros das camadas landing
...
def fintalk_dag() -> None:
    ...
    to_gold_tasks = AirflowUtil().create_dbt_task_group(
        ...
        schema="fintalk",
        select_paths=["path:models/gold/fintalk"],
        exclude=[""],
    )
